# SeeBorg — PWA de suivi fitness + n8n

**SeeBorg** — application de suivi fitness installable sur iPhone (PWA, sans App Store) :
programme d'entraînement (templates prêts à l'emploi), cases à cocher par exercice, suivi de
poids, dashboard de progression — et un coach virtuel qui envoie des messages motivants en
français sur Discord (félicitations après séance, rappel du soir, bilan hebdomadaire).
